...
class User(AbstractBaseUser):
	...
	phoneValidator = RegexValidator(regex=r'^\+?1?\d{9,15}$', 
	...
	profileIds = models.CharField(max_length=4000, null=True, blank=True)
	activeProfileId = models.CharField(max_length=32, null=True, blank=True)
	locationIds = models.CharField(max_length=4000, null=True, blank=True)
	activeLocationId = models.CharField(max_length=32, null=True, blank=True)
	applicationIds = models.CharField(max_length=4000, null=True, blank=True)
